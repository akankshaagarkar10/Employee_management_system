...
import java.util.*;//for generating random number
...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee()
    {
        ...
        String courses[]={"BBA","BCA","B.COM","BTech","BE","BSc","MBA","MCA","MTech","MSc"};
        ...
        lblempId = new JLabel(""+number);//adding those double invered commas converts the number integer into string
